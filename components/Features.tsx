...
const features: Feature[] = [
  {
    title: "Modern-industrial yang nyaman",
    text: "Desain bersih dengan sentuhan hangat dan area hijau yang terasa estetik tapi tetap fungsional.",
    icon: (
      <path
  ...
  },
  {
    ...
    text: "Cocok untuk nongkrong lama tanpa khawatir biaya, baik untuk kopi, snack, maupun makanan berat.",
    icon: (
      <path
  ...
  {
    title: "Free WiFi",
    text: "Internet stabil untuk work from cafe, meeting ringan, browsing, dan upload kerjaan.",
    icon: (
      <path
  ...
  {
    title: "Indoor & outdoor luas",
    text: "Pilihan area yang fleksibel, dari suasana tenang untuk fokus sampai sudut santai untuk nongkrong.",
    icon: (
      <path
  ...
  },
  {
    ...
    text: "Area hiburan yang bikin datang ke MOSAC terasa lebih interaktif dan seru bareng teman.",
    icon: (
      <path
  ...
  },
  {
    ...
    text: "Dekat pintu Tol Citeureup, mudah dijangkau untuk singgah, meeting, atau hangout sepulang aktivitas.",
    icon: (
      <path
        ...
        <div className="mb-12 grid gap-8 lg:grid-cols-[0.9fr_1.1fr] lg:items-end">
          <div className="max-w-2xl">
            ...
            <h2 className="section-title mt-4">
              Fasilitas yang bikin MOSAC terasa pas untuk banyak kebutuhan.
            </h2>
          </div>
          <p className="max-w-2xl text-sm leading-7 text-muted lg:ml-auto lg:text-base">
            MOSAC dirancang sebagai ruang yang bisa dipakai dengan banyak cara:
            buat fokus bekerja, santai menikmati kopi, makan bareng teman,
            sampai recharge sebentar di tempat yang tetap terasa nyaman.
          </p>
        </div>
